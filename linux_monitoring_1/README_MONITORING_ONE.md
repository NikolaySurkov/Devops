...
**DATE** = _current time as: **23 May 2023 23:56:36**_  
...
**RAM_TOTAL** = _main memory size in GB with an accuracy of three decimal places as: **5.145 GB**_  
...
**SPACE_ROOT** = _root partition size in MB, with an accuracy of two decimal places, as **454.25 MB**_  

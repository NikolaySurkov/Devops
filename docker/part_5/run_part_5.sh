...
# cd ..
echo ""
echo "Cобираем образ hello_world_server:part_5"
docker build  -f Dockerfile_5  -t hello_world_server:part_5 .
echo ""
echo "Запускаем контейнер miniserver_part_5"
docker run -dt -p 80:81 --name miniserver_part_5 hello_world_server:part_5 
echo ""
echo "===================================="
...
echo ""
echo "===================================================================="
echo "==== вывод проверки образа \"hello_world_server:part_5\"   dockle ===="
echo "===================================================================="
dockle --ignore CIS-DI-0010 hello_world_server:part_5
echo ""
